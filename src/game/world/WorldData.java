...
public class WorldData {
	...
	public WorldData(int tileWidth, int tileHeight, String tileSetPath, String tileSetIDsPath, String worldBGDataPath, String worldFGDataPath) {
		this.tileSet = new TileSet(PathConstants.TILESET_BASE_PATH + "world/tileset.png", PathConstants.TILESET_BASE_PATH + "world/ids.dat");
